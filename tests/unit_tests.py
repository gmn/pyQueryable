...
class QueryableTests(unittest.TestCase):
    ...
    def test_update(self):
        ...
        self.assertEqual(db._data, [{'x':666,'_id':1},{'x':666,'_id':2}])
        db.update({'b':1},{'$set':{'b':777}},{'upsert':True})
        self.assertEqual(db._data, [{'x':666,'_id':1},{'x':666,'_id':2},{'b':777,'_id':3}])
        p('UPDATE')

    # just distinct k,v sets:  a:1, a:0, a:1, a:0 --> a:1, a:0
    def test_distinct(self):
        ...
        res.data[0]['a'] = 666 # make sure changing result isn't the same python object as main set
